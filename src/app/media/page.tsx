...
export const metadata: Metadata = {
  title: "ラウンジ",
  description:
    "CLUB CHUCHOTERのラウンジ。公式ポスター、女性キャスト・スタッフ募集のご案内。",
};
  ...
  return (
    <>
      <PageHero
        titleEn="The Lounge"
        titleJa="ラウンジ"
        description="CLUB CHUCHOTERの公式ポスターと、女性キャスト・スタッフの募集情報をご案内しております。"
      />
        ...
        <div className="site-container">
          ...
          <ScrollReveal delay={0.08}>
            <figure className="mx-auto flex w-full max-w-2xl flex-col items-center md:max-w-3xl">
              ...
              <img
                src={POSTER_SRC}
                alt="CLUB CHUCHOTER 公式ポスター — キャスト一覧、開催日時、参加方法（Request Invite）、VRChat ID・公式X"
      ...
      >
        <div className="site-container">
          ...
          <div className="mx-auto max-w-3xl space-y-3 text-sm leading-[1.85] text-cream-muted">
            <p>
              CLUB CHUCHOTERでは、女性キャストおよびスタッフを募集しております。完全私室でのおもてなしや、クラブ運営に携わりたい方を歓迎いたします。
            </p>
            <p>
